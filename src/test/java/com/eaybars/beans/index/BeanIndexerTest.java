...
public class BeanIndexerTest {
    ...
    public void setUp() {
        b1 = BeanIndexer.beanIndexFrom(IndexedBean1.class);
                b1.add(new IndexedBean1("abc", 1));
                b1.add(new IndexedBean1("abc", 2));
                b1.add(new IndexedBean1("xyz", 1));
                b1.add(new IndexedBean1("xyz", 2));
                b1.add(new IndexedBean1("qwerty", 8));
        b2 = BeanIndexer
                .beanIndexFrom(IndexedBean2.class);
                b2.add(new IndexedBean2("b1").addBean(new IndexedBean1("abc", 1))
                        .addBean(new IndexedBean1("abc", 2)));
                b2.add(new IndexedBean2("b2").addBean(new IndexedBean1("xyz", 1))
                        .addBean(new IndexedBean1("xyz", 2)));
                b2.add(new IndexedBean2("b3").addBean(new IndexedBean1("qwr", 8)));
    }
    ...
    public void basicSetTest() {
        ...
        assertTrue(b1.contains(new IndexedBean1("abc", 1)));
        assertFalse(b1.add(new IndexedBean1("abc", 1)));
        assertTrue(b1.remove(new IndexedBean1("abc", 1)));
        assertFalse(b1.contains(new IndexedBean1("abc", 1)));
        
        Iterator<IndexedBean1> i = b1.iterator();
        assertTrue(i.hasNext());
        IndexedBean1 b = i.next();
        i.remove();
    ...
    public void removeTest() {
        ...
        Set<Object> values = b1.getAllValuesForProperty("name");
    ...
    public void clearTest() {
        b1.clear();
        assertEquals(Collections.emptySet(), b1);
        assertEquals(Collections.emptySet(), b1.filter().having("name", "abc")
                .results());
    }
    ...
    public void propertyValuesTest() {
        Set<Object> set = b1.getAllValuesForProperty("name");
    ...
    public void comparatorIndexTest() {
        ...
        indexer.add(new ReadOrWriteOnlyBean("a", 2));
        indexer.add(new ReadOrWriteOnlyBean("a", 3));
